...
- Ассистент использует GPT-5.6 Luna (`gpt-5.6-luna`) через OpenAI Responses API.
...
- Поиск недостающих фактов является политикой по умолчанию, а не случайным действием с вероятностью «90%». Если отсутствующий факт влияет на подбор, сравнение, технический ответ или рекомендацию, ассистент обязан самостоятельно продолжить проверку в текущем ходе: сначала использовать каталог и сохранённые проверенные факты, затем официальный сайт, руководство или технический паспорт производителя, после этого — другие надёжные профильные источники, и только затем повторно оценить товар и сформировать ответ.
- Отсутствие характеристики или подтверждения в карточке не означает, что товар не подходит. Такой товар нельзя исключать только из-за неполноты данных: при отсутствии подтверждённого противоречия он остаётся кандидатом для предварительной рекомендации и внешней проверки. Код должен блокировать товар при доказанном конфликте с обязательным требованием, а не при простой нехватке сведений.
- Нельзя предлагать обращение к специалисту, контактную форму, звонок или передачу запроса до исчерпания доступных источников и разумных попыток самостоятельного поиска. Если сведения найдены, ассистент отвечает покупателю напрямую без лишней эскалации.
- Только если после самостоятельного поиска подтверждающих данных действительно нет, ассистент кратко называет конкретный неподтверждённый факт, не выдает отсутствие подтверждения за несовместимость и предлагает уточнить его у технического специалиста. После этого можно предложить покупателю оставить номер и выбрать удобный способ получения результата: сообщение или звонок.
- Крайний ответ после безрезультатного поиска должен сохранять полезный предварительный вывод, а не превращаться в отказ. Обязательная смысловая последовательность: назвать модель или вариант, который выглядит подходящим по уже подтверждённым характеристикам; точно указать, какой решающий факт не удалось подтвердить; честно сказать, что окончательно утверждать без него нельзя; предложить передать именно этот вопрос техническому специалисту; попросить номер и уточнить удобный способ ответа — написать или позвонить. Допустимая естественная формулировка: «По имеющимся характеристикам эта модель выглядит подходящей, но подтверждающих данных по [конкретный неподтверждённый факт] сейчас найти не удалось, поэтому окончательно утверждать не буду. Могу передать вопрос техническому специалисту и сообщить результат. Оставьте номер и скажите, как удобнее связаться — написать или позвонить?» Формулировку можно адаптировать к диалогу, но нельзя убирать предварительный полезный вывод, конкретный пробел в данных, предложение уточнения и выбор способа связи.
- Ассистент не должен обещать, что запрос передан, специалист уже уточняет данные или результат обязательно будет сообщён, пока контакт не получен и `lead.capture` не завершился успешно. После успешного создания заявки он подтверждает передачу запроса и выбранный покупателем способ связи.
