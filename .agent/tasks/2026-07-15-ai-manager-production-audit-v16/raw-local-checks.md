...
Verification timestamp: `2026-07-16T00:15:27+03:00`.
...
- malformed combined ledger output falls back to a separate reducer and discards the sibling intent before replanning;
...
- combined Terra understanding returns ledger delta and intent in one structured call while preserving separate durable checkpoints.
