...
} from './assistantNeedExtractionSchemas.js';
import { turnPlanSchema } from './assistantTurnPlanSchemas.js';
import { coerceSemanticMemory } from './semanticMemoryCoercion.js';
import {
    ...
    const plannerRequest = {
      ...
      text: {
        format: {
          ...
          strict: true,
          schema: turnPlanSchema(MAX_PRODUCT_CARDS)
        }
      },
