...
function embedScript(baseUrl: string) {
  ...
  style.textContent =
    ...
    '#bakaut-ai-widget-launcher{position:relative;display:grid;place-items:center;min-width:72px;width:72px;height:72px;padding:0;border:0;border-radius:999px;background:#0f766e;color:#fff;box-shadow:0 18px 42px rgba(15,23,42,.34),0 0 0 1px rgba(255,255,255,.18);cursor:pointer;overflow:visible;pointer-events:auto;transition:transform .18s ease,box-shadow .18s ease;background-image:radial-gradient(circle at 32% 28%,rgba(255,255,255,.32),rgba(255,255,255,0) 34%),linear-gradient(135deg,#111827,#0f766e)}' +
    ...
    '.bakaut-ai-widget-pulse{position:absolute;inset:-8px;border-radius:999px;box-shadow:0 0 0 0 rgba(20,184,166,.55);animation:bakautAiPulse 1.8s infinite;pointer-events:none}' +
    '.bakaut-ai-widget-avatar{width:54px;height:54px;flex:0 0 54px;border-radius:999px;background:#f97316;display:grid;place-items:center;font-weight:800;overflow:hidden;box-shadow:0 0 0 3px rgba(255,255,255,.16)}' +
